...
const CUSTOMERS = [
  { id: "CUST-001", name: "Alice Freeman", email: "alice@example.com", spent: "₦45,000.00", orders: 3, status: "Active", date: "2026-05-12" },
  { id: "CUST-002", name: "Bobby Tables", email: "bobby@example.com", spent: "₦12,000.00", orders: 1, status: "Active", date: "2026-06-01" },
  { id: "CUST-003", name: "Charlie Davis", email: "charlie@example.com", spent: "₦89,000.00", orders: 7, status: "VIP", date: "2026-06-05" },
  { id: "CUST-004", name: "Diana Prince", email: "diana@example.com", spent: "₦5,000.00", orders: 1, status: "Inactive", date: "2025-12-10" },
  { id: "CUST-005", name: "Evan Wright", email: "evan@example.com", spent: "₦32,000.00", orders: 2, status: "Active", date: "2026-06-08" },
];
      ...
      <div className="rounded-[2.5rem] border-[4px] border-border bg-white p-8 shadow-vibe">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between mb-8">
          <div>
            ...
            <p className="mt-2 text-base font-bold text-foreground/70">Manage your audience and view purchase history.</p>
          </div>
              ...
              <tbody className="divide-y-[3px] divide-border font-medium">
                {CUSTOMERS.map((c) => (
                  <tr key={c.id} className="transition-colors hover:bg-muted/50">
                    ...
                    <td className="py-4">
                      <span className={`inline-flex items-center rounded-full border-[3px] border-border px-3 py-1 text-xs font-black shadow-vibe-sm ${c.status === "VIP" ? "bg-tint-rose text-foreground" : c.status === "Active" ? "bg-tint-mint text-foreground" : "bg-tint-cream text-foreground"}`}>
                        {c.status}
                      </span>
                    </td>
