      ...
      <main id="main-content">
        <section className="container-page py-16 md:py-24 text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg font-medium text-foreground/80">
            Start free. We only make money when you make money. No setup fees, no monthly
            subscriptions.
          </p>
        </section>
        <section className="container-page pb-16">
          <div className="mx-auto max-w-3xl">
            <div className="relative overflow-hidden flex flex-col items-center rounded-[4rem] border-[4px] border-border bg-tint-mint p-10 text-center text-foreground shadow-vibe md:p-16">
              ...
              <p className="relative z-10 mt-3 text-lg font-bold text-foreground/80">
                Everything you need to sell digital products.
              </p>
              <p className="relative z-10 mt-10 font-display text-8xl font-black">10%</p>
              <p className="relative z-10 mt-2 text-lg font-black text-foreground/80 uppercase tracking-wide">
                per successful sale
              </p>
              ...
              <Link
                to="/signup"
                className="relative z-10 mt-16 w-full max-w-md rounded-full border-[3px] border-border bg-primary px-10 py-5 text-xl font-black text-white shadow-vibe shadow-vibe-hover transition-transform hover:-translate-y-1"
              >
                Start selling today
              </Link>
            </div>
          ...
          <div className="mx-auto mt-16 max-w-3xl rounded-[3rem] border-[4px] border-border bg-white p-8 shadow-vibe md:p-12 relative overflow-hidden">
            ...
            <h2 className="relative z-10 font-display text-3xl font-black text-foreground">
              Payment Gateway Fees
            </h2>
            <p className="relative z-10 mt-4 text-lg font-medium text-foreground/80 leading-relaxed">
              Cetoh partners with Paystack to securely process all transactions. Paystack charges a
              standard payment processing fee which is deducted from the total transaction amount
              before your payout.
            </p>
              ...
              <div>
                ...
                <p className="mt-4 text-base font-medium leading-relaxed text-foreground/90">
                  ...
                  <span className="block mt-2 font-bold">
                    • Paystack processing fee: ₦250 (1.5% + ₦100)
                  </span>
                  <span className="block mt-1 font-bold">• Cetoh flat fee: ₦1,000 (10%)</span>
                  <span className="block mt-4 text-xl font-black text-primary">
                    You receive: ₦8,750 directly to your bank account.
                  </span>
                </p>
              </div>
            </div>
