      ...
      <div className="flex flex-col gap-8">
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-[2rem] border-[4px] border-border bg-white p-6 shadow-vibe transition-transform hover:-translate-y-1">
            ...
            <div>
              <div className="mt-4 font-display text-4xl font-black text-foreground">₦1,245,000</div>
              <p className="mt-3 flex items-center text-sm font-bold text-foreground">
                <span className="inline-flex items-center rounded-full bg-tint-mint px-2 py-0.5 text-xs mr-2 border-2 border-border shadow-vibe-sm"><ArrowUpRight className="mr-1 h-3 w-3 stroke-[3px]" /> +15.2%</span> from last week
              </p>
            </div>
          </div>
          <div className="rounded-[2rem] border-[4px] border-border bg-white p-6 shadow-vibe transition-transform hover:-translate-y-1">
            ...
            <div>
              ...
              <p className="mt-3 flex items-center text-sm font-bold text-foreground">
                <span className="inline-flex items-center rounded-full bg-tint-mint px-2 py-0.5 text-xs mr-2 border-2 border-border shadow-vibe-sm"><ArrowUpRight className="mr-1 h-3 w-3 stroke-[3px]" /> +8.1%</span> from last week
              </p>
            </div>
          </div>
          <div className="rounded-[2rem] border-[4px] border-border bg-white p-6 shadow-vibe transition-transform hover:-translate-y-1">
            ...
            <div>
              ...
              <p className="mt-3 flex items-center text-sm font-bold text-foreground">
                <span className="inline-flex items-center rounded-full bg-tint-mint px-2 py-0.5 text-xs mr-2 border-2 border-border shadow-vibe-sm"><ArrowUpRight className="mr-1 h-3 w-3 stroke-[3px]" /> +1.2%</span> from last week
              </p>
            </div>
          </div>
          <div className="rounded-[2rem] border-[4px] border-border bg-white p-6 shadow-vibe transition-transform hover:-translate-y-1">
            ...
            <div>
              ...
              <p className="mt-3 flex items-center text-sm font-bold text-foreground">
                <span className="inline-flex items-center rounded-full bg-tint-mint px-2 py-0.5 text-xs mr-2 border-2 border-border shadow-vibe-sm"><ArrowUpRight className="mr-1 h-3 w-3 stroke-[3px]" /> +12.5%</span> from last week
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="h-[400px] w-full pt-4 font-bold">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
                  ...
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="hsl(var(--border))" strokeWidth={2} opacity={0.5} />
                  <XAxis dataKey="name" stroke="hsl(var(--foreground))" fontSize={14} tickLine={false} axisLine={false} dy={10} />
                  <YAxis stroke="hsl(var(--foreground))" fontSize={14} tickLine={false} axisLine={false} tickFormatter={(value) => `₦${value}`} dx={-10} />
                  <Tooltip 
                    contentStyle={{ backgroundColor: "white", border: "4px solid hsl(var(--border))", borderRadius: "1rem", color: "hsl(var(--foreground))", boxShadow: "4px 4px 0px 0px rgba(0,0,0,1)" }}
                    itemStyle={{ color: "hsl(var(--foreground))", fontWeight: "900", fontFamily: "Fredoka" }}
                  />
                  <Area type="monotone" dataKey="views" stroke="#A8F0CB" strokeWidth={4} fillOpacity={1} fill="url(#colorViews)" />
                  <Area type="monotone" dataKey="revenue" stroke="#101828" strokeWidth={4} fillOpacity={1} fill="url(#colorRevenue)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
