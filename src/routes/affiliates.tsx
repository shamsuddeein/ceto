        ...
        <section className="relative overflow-hidden pt-24 pb-32">
          ...
          <div className="container-page relative z-10 text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-foreground/70 sm:text-xl animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200 fill-mode-both">
              Join the industry's most lucrative affiliate network. Promote digital products,
              courses, and software from top creators and get paid directly to your bank account.
            </p>
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row animate-in fade-in slide-in-from-bottom-6 duration-700 delay-300 fill-mode-both">
              <Link
                to="/signup"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 text-base font-bold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:scale-105 hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/30"
              >
                Apply to the Network <ArrowRight className="h-5 w-5" />
              </Link>
              <Link
                to="/login"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-surface/50 backdrop-blur-sm px-8 py-4 text-base font-bold text-foreground transition-all hover:bg-accent hover:border-primary/50"
              >
                Affiliate Login
              </Link>
            </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="group relative overflow-hidden rounded-3xl border border-border/50 bg-surface/40 p-8 backdrop-blur-md transition-all hover:-translate-y-2 hover:border-primary/50 hover:bg-surface/80 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Earn anywhere from 20% to 75% on every successful referral. Our creators set the
                rates, but our network enforces high conversion standards.
              </p>
            </div>
            <div className="group relative overflow-hidden rounded-3xl border border-border/50 bg-surface/40 p-8 backdrop-blur-md transition-all hover:-translate-y-2 hover:border-blue-500/50 hover:bg-surface/80 hover:shadow-2xl hover:shadow-blue-500/10">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Cetoh's highly optimized checkout flows mean your traffic actually converts. Stop
                sending your hard-earned traffic to leaky funnels.
              </p>
            </div>
            <div className="group relative overflow-hidden rounded-3xl border border-border/50 bg-surface/40 p-8 backdrop-blur-md transition-all hover:-translate-y-2 hover:border-purple-500/50 hover:bg-surface/80 hover:shadow-2xl hover:shadow-purple-500/10">
              ...
              <p className="text-foreground/70 leading-relaxed">
                Track your clicks, conversions, and payouts in real-time. Our pro dashboard gives
                you the crystal clear data you need to scale your campaigns.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-page relative z-10">
            <div className="mb-16 text-center">
              ...
              <p className="mx-auto max-w-2xl text-lg text-foreground/70">
                Three simple steps to build your passive income machine.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Sign up for a free affiliate account. Approval is instant for verified creators and marketers.",
                },
                {
                  title: "Find Products",
                  desc: "Browse the marketplace and generate unique, un-blockable tracking links for products.",
                },
                {
                  title: "Get Paid",
                  desc: "Share your links. When someone buys, you get paid automatically to your bank account.",
                },
              ].map((step, i) => (
